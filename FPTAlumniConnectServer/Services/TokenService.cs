...
using FPTAlumniConnectServer.Settings;
    ...
    public class TokenService : ITokenService
    {
        ...
        public UserDTO GetUserFromExpiredToken(string token)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(email) || string.IsNullOrEmpty(roleClaim))
                {
        ...
        public (string Token, string RefreshToken) RefreshToken(string accessToken, string refreshToken)
        {
            ...
            var newRefreshToken = GenerateRefreshToken(userDTO.Email);
